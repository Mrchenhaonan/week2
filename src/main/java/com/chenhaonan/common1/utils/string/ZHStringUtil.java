...
public class ZHStringUtil {
	public static String getZHString(){
		String str=null;
		int highPos,lowPos;
	...
	public static String getZHName(){
		...
		String name1=str[RandNumUtil.random(0, str.length-1)];
		String name2=getZHString(RandNumUtil.random(1, 2));
		return name1+name2;
